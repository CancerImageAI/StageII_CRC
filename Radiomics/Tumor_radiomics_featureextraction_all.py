...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(List_Num))):
        ...
        if os.path.exists(img_path+'/'+str(dcm_File)):
            ...
            mask_path = mask_root+'/'+str(dcm_File)+'/'+str(dcm_File)+'.nii'
            if ~os.path.exists(mask_path):
                mask_path = mask_root+'/'+str(dcm_File)+'/'+str(dcm_File)+'.nii.gz'

        else:
            roi_path = '../../TestData/DICOM/'+str(dcm_File)
            mask_path = '../../TestData/ROI/'+str(dcm_File)+'.nii.gz'
            if ~os.path.exists(mask_path):
                mask_path = '../../TestData/ROI'+'/'+str(dcm_File)+'.nii'
        try:
    ...
    df.to_csv('../../Results/Radiomics_Feature.csv',index=False,sep=',')
